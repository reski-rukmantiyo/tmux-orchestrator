...
For detailed procedures and protocols, reference these specialized knowledge modules:

- **Git Workflow**: @docs/git_protocol.md - Mandatory git discipline for all agents
- **Tmux Operations**: @docs/tmux_cookbook.md - Complete guide for tmux orchestration
- **Communication**: @docs/communication_protocols.md - Team communication patterns and rules
- **Agent Management**: @docs/agent_management.md - Agent lifecycle, deployment, and QA protocols

## Available Commands

- `/project:start` - Systematic project startup sequence (see .claude/commands/project_start.md)
